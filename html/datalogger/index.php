<html>
<head>
  <title>Oak Wheather Overview</title>
  <meta charset="UTF-8">
...
<body>
  ...
  <div id="content">
    ...
    <table class="data">
      <tr>
        <td><div id="temperature" style="height: 45%; margin: 0 auto"></div></td>
        <td><div id="humidity" style="height: 45%; margin: 0 auto"></div></td>
      </tr>
      <tr>
        <td><div id="pressure" style="height: 45%; margin: 0 auto"></div></td>
        <td><div id="ambient" style="height: 45%; margin: 0 auto"></div></td>
      </tr>
    </table>
    </div>
  </div> 
